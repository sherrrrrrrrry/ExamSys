...
jQuery(document).ready(function($) {
	...
	$('#post-slider').flexslider({
		// Primary Controls
		controlNav : false, // Boolean: Create navigation for paging control of
							// each clide? Note: Leave true for manualControls
							// usage
		...
		controlsContainer : "", // {UPDATED} Selector: USE CLASS SELECTOR.
								...
								// container is the FlexSlider element. Example
								// use would be ".flexslider-container".
								// Property is ignored if given element is not
								// found.
		manualControls : "", // Selector: Declare custom control navigation.
								// Examples would be ".flex-control-nav li" or
								// "#tabs-nav li img", etc. The number of
								// elements in your controlNav should match the
